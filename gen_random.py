...
def main():
    target_level, chosen_class, ancestry = gen_character.parse_args()
    ...
    if not chosen_class: chosen_class = random.choice(classes)
    if not ancestry: ancestry = random.choice(ancestries)
